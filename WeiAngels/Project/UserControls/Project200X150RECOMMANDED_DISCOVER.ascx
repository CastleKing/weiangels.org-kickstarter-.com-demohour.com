<%@ control language="C#" autoeventwireup="true" inherits="Project_UserControls_Project200X150RECOMMANDED_DISCOVER, App_Web_project200x150recommanded_discover.ascx.90d9c57a" %>
<div class="new_project_item">
    ...
    <p class="project_meta" style="margin-bottom:0;">
        <span class="s_tips" style="background:#ff2b13;">取消！日期<%=Project.DueDate.ToString("yyyy/MM/dd") %></span>
        </p>
        <table width="100%">
        <tr>
            <td style="font-weight:bold; color:#666;"><%=Project.TotalBackPercentage%>%<br /><font style="color:#999; font-weight:normal;">已资助比例</font></td>
