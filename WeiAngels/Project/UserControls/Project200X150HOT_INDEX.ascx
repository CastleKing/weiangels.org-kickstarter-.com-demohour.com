<%@ control language="C#" autoeventwireup="true" inherits="Project_UserControls_Project200X150HOT_INDEX, App_Web_project200x150hot_index.ascx.90d9c57a" %>
<div class="hot_project_item">
    ...
    <%}
      ...
      <%} else { %>
    <p class="hot_project_meta">
        <span class="processbar"><img src="../images/project_process2.gif" width="<%=Project.TotalBackPercentage %>%" height="8" /></span>
