<%@ page title="" language="C#" masterpagefile="~/MasterPages/MasterPage.master" autoeventwireup="true" inherits="Account_LoginFromShare, App_Web_loginfromshare.aspx.dae9cef9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainWrapper" Runat="Server">
	<div class="info">
		<div class="hero_info"><img src="../images/share_title_bg.png" /></p>
		</div>
	</div>
	<div class="mainbody">
		<div class="step">
			<img src="../images/crative_step1.gif" width="322" height="174" />
			<img src="../images/crative_step2.gif" width="322" height="174" />
			<img src="../images/crative_step3.gif" width="322" height="174" />
		</div>
	</div>
	<div class="form">
		<div class="form_middle">
			...
			<div class="login_form">
				...
				<p>&nbsp; </p>
				<b><span style="float:right"><a id="linkForgetPwd" href="http://weiangels.org/weiangels.htm">忘记密码？</a></span>密码</b>
        ...
        <b>验证码</b>
			...
			<%--<div class="other_form">
				...
				<p style="margin-top: 10px;">
					...
					<a href="#">
						<img src="../images/openid_login_google.png" width="137" height="36" />
					</a><br />
					<a href="#">
						<img src="../images/openid_login_yahoo.png" width="137" height="36" />
					</a>
				</p>
				<p>&nbsp; </p>
			</div>--%>
