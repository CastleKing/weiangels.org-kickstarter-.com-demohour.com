<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="AccountingApplication_PersonalAccountDetail, App_Web_personalaccountdetail.aspx.8f74f10" title="Untitled Page" theme="Basic" %>
<%@ Register Src="~/AccountingApplication/UserControls/BackMoney.ascx" TagName="BACKMONEY" TagPrefix="BM" %>
